...
const EXAMPLES = [
    {
        questDescription: `[You can easily survive and finish this quest.] Deliver item Item 63718: Handwritten Letter (Artifact) [Rare] to person Lia Kaelar at location Cobbled Alley (1295) [cool, wet]`,
    ...
    {
        questDescription: `[This quest is impossible to finish. You will die.] Deliver item Item 63725: Handwritten Letter (Artifact) [Rare] to person Vladlen of Fyodorov at location The Crooked Market (5387) [cool, normal]`,
    ...
    {
        questDescription: `[This quest is extremely difficult.] Slay the Dragon at location Mount Doom (9999) [hot, volcanic]`,
    ...
    {
        questDescription: `[You can easily survive and finish this quest.] Help repair the broken bridge at location River Crossing (3210) [rainy, slippery]`,
    ...
    {
        questDescription: `[This quest is impossible to finish. You will die.] Retrieve the Lost Artifact from location Abyssal Depths (8888) [dark, unknown]`,
    ...
    {
        questDescription: `[You can easily survive and finish this quest.] Deliver this package to person Anna Green at location Sunnyvale Farm (7777) [warm, cheerful]`,
